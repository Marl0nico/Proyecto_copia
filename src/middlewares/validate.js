...
// Middleware para validar los datos de actualización del administrador
export const validateUpdate = [
  upload.single('imagen'),  // 'imagen' es el campo del formulario para la imagen
  uploadImage,  // Middleware que sube la imagen a Cloudinary si se proporciona
  body('name')
    .optional()
...
//-------------------------------------------------------------------------------------------------------------------
// Middleware para validar los datos de creación de carrera
export const validateCreateCareer = [
  ...
  body('name')
    ...
    .trim(),
  body('description')
    .notEmpty().withMessage('La descripción de la carrera es obligatoria')
    .trim(),
  (req, res, next) => {
    // Si hay errores en la validación, los devuelve
    const errors = validationResult(req);
...
// Middleware para validar los datos de actualización de carrera
export const validateUpdateCareer = [
  upload.single('imagen'),  // 'imagen' es el campo del formulario para la imagen
  uploadImage,  // Middleware que sube la imagen a Cloudinary
  body('name')
    .optional()
